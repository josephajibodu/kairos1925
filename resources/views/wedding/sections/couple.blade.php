...
<section class="wpo-couple-section-s2 section-padding" id="couple">
                        ...
                        <div class="couple-img-wrap">
                            <div class="couple-common point__item" data-position="left-top" data-point="middle"
                                ...
                                <div class="couple-img">
                                    <img src="{{ asset('assets/images/couple/bride.png') }}" alt="">
                                </div>
                            </div>
                            <div class="couple-common point__item" data-position="right" data-point="middle"
                                data-path="280">
                                <div class="couple-img">
                                    <img src="{{ asset('assets/images/couple/groom.png') }}" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="couple-common couple-text-wrap">
                            <div class="couple-text-l-item">
                                <div class="couple-text-bg point__item top" data-position="center-top" data-point="left"
                                    data-path="280">
                                    <svg class="shape-bg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 667 413"
                                        fill="none">
                                        <path
                            ...
                            <div class="couple-text-r-item">
                                <div class="couple-text-bg point__item" data-position="left-bottom"
                                    ...
                                    <svg class="shape-bg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 591 440"
                                        fill="none">
                                        <path
    ...
    <div class="left-shape">
        <img src="{{ asset('assets/images/couple/left.svg') }}" alt="">
    </div>
    <div class="right-shape">
        <img src="{{ asset('assets/images/couple/right.svg') }}" alt="">
    </div>
</section>
<!-- end couple-section -->