                ...
                <div class="col col-md-12 col-12">
                    <div class="couple-item-wrap pointparallax">
                        <div class="couple-img-wrap">
                            <div class="couple-common point__item" data-position="left-top" data-point="middle" data-path="280">
                                <div class="couple-img">
                                    <img src="{{ asset('assets/images/couple/bride.png') }}" alt="">
                                </div>
                            </div>
                            <div class="couple-common point__item" data-position="right" data-point="middle" data-path="280">
                                <div class="couple-img">
                                    ...
                                    <div class="couple-text">
                                        ...
                                        <div class="social">
                                            <ul>
                                                ...
                                                <li><a href="{{ config('wedding.social.twitter', '#') }}"><i class="ti-twitter-alt"></i></a></li>
                                                <li><a href="{{ config('wedding.social.instagram', '#') }}"><i class="ti-instagram"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
