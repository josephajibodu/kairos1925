    ...
    'gifts' => [
        ...
        'online_payment_options' => [
            ...
            [
                ...
                'description' => 'Contribute to our beautiful decorations',
                'amount' => '₦10,000',
                'link' => env('WEDDING_GIFT_LINK_2', '#'),
                'icon' => 'ti-palette',
                'col_class' => 'col-lg-4 col-md-6 col-12',
            ],
            [
                'title' => 'Photography & Videography',
                'description' => 'Help us capture our special moments',
                'amount' => '₦15,000',
                'link' => env('WEDDING_GIFT_LINK_3', '#'),
                'icon' => 'ti-camera',
                'col_class' => 'col-lg-4 col-md-6 col-12',
            ],
            [
                'title' => 'Wedding Venue',
                'description' => 'Support our beautiful venue setup',
                'amount' => '₦20,000',
                'link' => env('WEDDING_GIFT_LINK_4', '#'),
                'icon' => 'ti-home',
                'col_class' => 'col-lg-4 col-md-6 col-12',
            ],
            [
                'title' => 'Wedding Music & Entertainment',
                'description' => 'Help us create the perfect atmosphere',
                'amount' => '₦25,000',
                'link' => env('WEDDING_GIFT_LINK_5', '#'),
                'icon' => 'ti-music',
                'col_class' => 'col-lg-4 col-md-6 col-12',
            ],
            [
                'title' => 'Wedding Catering',
                'description' => 'Support our delicious wedding feast',
                'amount' => '₦50,000',
                'link' => env('WEDDING_GIFT_LINK_6', '#'),
                'icon' => 'ti-cutlery',
                'col_class' => 'col-lg-4 col-md-6 col-12',
            ],
            [
                'title' => 'Honeymoon Fund',
                'description' => 'Help us create beautiful memories',
                'amount' => '₦75,000',
                'link' => env('WEDDING_GIFT_LINK_7', '#'),
                'icon' => 'ti-plane',
                'col_class' => 'col-lg-4 col-md-6 col-12',
            ],
            [
                'title' => 'Wedding Rings & Jewelry',
                'description' => 'Support our special wedding symbols',
                'amount' => '₦100,000',
                'link' => env('WEDDING_GIFT_LINK_8', '#'),
                'icon' => 'ti-diamond',
                'col_class' => 'col-lg-4 col-md-6 col-12',
            ],
            [
