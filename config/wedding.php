...
Fast forward to July 6, 2025, after we both got back from an art exhibition in Lekki titled Echoes of Innocence, Joseph got down on one knee, and I said YES! 💕 That moment wasn\'t just a proposal, it was the fulfillment of a promise. And today, that promise is becoming our forever.',
    ...
    'gifts' => [
        ...
        'appreciation' => [
            'enabled' => env('WEDDING_GIFTS_APPRECIATION_ENABLED', true),
            'title' => 'With Gratitude',
            'subtitle' => 'We are deeply grateful to everyone who has generously supported us financially in preparation for our special day',
            'people' => [
                ['name' => 'Lola Soyebo Harris', 'subtitle' => 'Kadara Woman', 'side' => 'bride'],
                ['name' => 'Taiwo Ajibodu', 'subtitle' => 'Uncle', 'side' => 'groom'],
                ['name' => 'Selar Inc.', 'subtitle' => 'Work Place', 'side' => 'groom'],
                ['name' => 'Nexa kitchen', 'side' => 'bride'],
                ['name' => 'Samuel Jolayemi', 'subtitle' => 'TedXOau', 'side' => 'bride'],
                ['name' => 'Boluwatife Alalade', 'side' => 'groom'],
                ['name' => 'Tobi Adewumi', 'side' => 'groom'],
                ['name' => 'Tobi', 'subtitle' => 'TedXOau', 'side' => 'bride'],
                ['name' => 'Favor Olamilekan', 'subtitle' => 'Tiktok Friend', 'side' => 'groom'],
                ['name' => 'Abdulrahman Adeola', 'subtitle' => 'IHA Colleague', 'side' => 'groom'],
                ['name' => 'Mayowa', 'side' => 'bride'],
                ['name' => 'Pastor Ajala', 'side' => 'bride'],
                ['name' => 'Awoyele Elizabeth', 'side' => 'groom'],
                ['name' => 'Kehinde Ologbenla', 'subtitle' => 'Cousin', 'side' => 'groom'],
            ],
        ],
    ],
];
